 ...
 */
 ...
 if(!isset($_pagi_nav_primera)){
	...
	// Se toma la cadena por defecto.
	//$_pagi_nav_primera = "&laquo;&laquo; Primera";	### ORIGINAL - MODIFICADO P/ RAFAEL EM 05/08/08 - 17:36HS
	$_pagi_nav_primera = "";
 } 
 ...
 if(!isset($_pagi_nav_ultima)){
	// Si no se ha elegido una cadena para el enlace "siguiente"
	// Se toma la cadena por defecto.
	//$_pagi_nav_ultima = "&Uacute;ltima &raquo;&raquo;";	### ORIGINAL - MODIFICADO P/ RAFAEL EM 05/08/08 - 17:36HS
	$_pagi_nav_ultima = "";
 } 
 ...
 */
 ...
 for ($_pagi_i = $_pagi_nav_desde; $_pagi_i<=$_pagi_nav_hasta; $_pagi_i++){//Desde página 1 hasta última página ($_pagi_totalPags)
	if ($_pagi_i == $_pagi_actual) {
		...
		//$_pagi_navegacion_temporal[] = "<span ".$_pagi_nav_estilo_mod.">$_pagi_i</span>";		### ORIGINAL - MODIFICADO P/ RAFAEL EM 05/08/08 - 17:43HS
		$_pagi_navegacion_temporal[] = "<span ".$_pagi_nav_estilo_mod."><strong>$_pagi_i</strong></span>";
	}else{
