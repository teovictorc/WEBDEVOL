<?
	...
	$Conn = mysql_connect("mysql1070.locaweb.com.br","andarella1","c3j6qt2"); //USUARIO,SENHA,DB
	//$Conn = mysql_connect("mysql.iphotel.com.br","freehold","ms170359"); //USUARIO,SENHA,DB
	// foi corrigida	mysql_select_db("arezzowfa",$Conn);
	 mysql_select_db("wfa",$Conn);
	//mysql_select_db("freehold",$Conn);
	$PaginaDeErro = "acesso_negado.php";
	
	//VARIAVEIS GLOBAIS
	$MailDefault = "rarfoto@arezzo.com.br"; // um e-mail válido, preciso configurar o mail
	//$PathImagens = "C:/Inetpub/wwwroot/AREZZO_mysql/fotos/"; //Precisa de permissão de Escrita e Leitura
	$PathImagens = "/home/wfa1/public_html/fotos/"; //Precisa de permissão de Escrita e Leitura
	$PathImportacao = "/home/wfa1/public_html/importacao/"; //Precisa de permissão de Escrita e Leitura
	$PathImportacaoVirtual = "/importacao/"; //Precisa de permissão de Escrita e Leitura
	$PathPdvDownload = "/home/wfa1/public_html/rv/"; //Precisa de permissão de Escrita e Leitura
