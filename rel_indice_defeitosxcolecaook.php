<? $Title = "Índice de Defeitos x Coleção";
	...
	$SQL = "select ITEM_COLECAO, sum(I.item_qtde) as QTDE ";
	...
	$SQL.= " group by ITEM_COLECAO ";

	$SQL.= " order by QTDE DESC, ITEM_COLECAO ";
...
<? $Total = 0;
	...
	while($Rs = mysql_fetch_assoc($Stmt)){ 
		...
		$SQL.= "       and I.ITEM_COLECAO  = '" .$Rs["ITEM_COLECAO"]. "' ";
		...
		$Total+= intval($Rs["QTDE"]); ?>
		  ...
		  <tr>
			...
			<div align="left" class="imp_normal_total_fundoamarelo"><strong>Cole&ccedil;&atilde;o:&nbsp;</strong><?=$Rs["ITEM_COLECAO"]?></div>      
