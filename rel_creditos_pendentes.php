...
<form name="form" method="post" action="rel_creditos_pendentesok.php" target="windowPrint">

<table width="100%"  border="0" align="center">

     <tr class="">

		 <td width="49%" class="tab_titulo" style="padding-top:15px;"><h4>Cr&eacute;ditos pendentes &nbsp;<?=$Categoria?></h4></td>
