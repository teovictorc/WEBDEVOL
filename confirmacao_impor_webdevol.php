...
&nbsp;                             <input name="Button" type="button" class="campo_texto" value="Confirmar sele&ccedil;&atilde;o" onClick="confirmIten();">
		  ...
		  <a href="confirmacao_impor_webdevol_devolver.php?Id=<?=$ID?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image352','','imagens/devolver_nf2.jpg',1)"><img src="imagens/devolver_nf.jpg" alt="Devolver NF por conter informações incorretas" name="Image352" width="87" height="20" border="0" id="Image352"></a>

		  <a href="pesq_impor_webdevol.php"><img src="../img/bts/cancelar.jpg" alt="Cancelar grava&ccedil;&atilde;o dos dados" name="Image361" border="0" id="Image361"></a></p></td>
...
function verificaForm(formObj) {
	...
	formObj.action = "confirmacao_impor_webdevolok.php";		
