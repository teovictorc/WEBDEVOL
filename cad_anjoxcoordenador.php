...
<table width="100%"  border="0" align="center">
     ...
     <tr>
       ...
       <td width="51%"><div align="right"><span class="titulo"><a href="javascript: abrir_help('#vincanjocoordenador_manut');">Help</a></span></div></td>
   ...
   <td colspan="9">
    ...
    <table width="100%"  border="0" class="tabela">
      ...
      <tr>
        ...
        <td width="20%" class="style2"><strong>Nome do anjo </strong></td>
      ...
      <tr>
        ...
        <td colspan="2"><table width="95%"  border="0" align="center">
          ...
          <tr class="topo_listagem">
            ...
            <td width="45%" class="topo_listagem"><div align="center">Coordenadores dispon&iacute;veis </div></td>

            <td width="10%" class="topo_listagem"><div align="center"></div></td>

            <td width="45%" class="topo_listagem"><div align="center">Coordenadores selecionados</div>              
            ...
            <td valign="top" class="campo_texto">
			  ...
			  <select name="USUAR_ACESS_FREE" size="10" multiple class="campo_texto" id="USUAR_ACESS_FREE">
				...
				<? 
					...
					" FROM pessoa p, rar_cliente_estrutura".

					" where pessoa = CLIEN_EST_COORDENADOR ".

					"       and pessoa NOT IN (SELECT anjco_pessoa ".

                                                "FROM rar_anjo_coordenador ".

											  " WHERE anjco_usuar_ido = '" .$ID. "')".
					...
					?>
				   		...
				   		<option value="<?=$Rs["PESSOA"]?>"><?=$Rs["NOME"]?></option>		   
            ...
            <td class="campo_texto"><div align="center"></div>              <div align="center">
			  ...
			  <select name="USUAR_ACESS" size="10" multiple class="campo_texto" id="USUAR_ACESS">
				...
				<? 
					...
					"       and pessoa IN (SELECT anjco_pessoa ".
      ...
      <tr>
        ...
        <td colspan="2"> <div align="center"><a href="javascript:verificaForm();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image351','','imagens/gravar2.jpg',1)">
          ...
          <? if (returnAcess("CADVINCSANJOCOORD") == "T") { ?>

          <img src="imagens/gravar.jpg" alt="Gravar dados" name="Image351" width="58" height="20" border="0" id="Image351">

          <? } ?>

        </a><a href="pesq_anjoxcoordenador.php?USUAR_IDO=<?=$ID?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image361','','imagens/cancelar2.jpg',1)"><img src="imagens/cancelar.jpg" alt="Cancelar grava&ccedil;&atilde;o dos dados" name="Image361" width="68" height="20" border="0" id="Image361"></a></div></td>
...
function verificaForm() {
	...
	document.form.action = "cad_anjoxcoordenadorok.php";		
