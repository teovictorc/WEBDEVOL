...
<form name="form" method="post" action="rel_indice_geral_fabrica_mensalok.php" target="windowPrint">

<table width="100%"  border="0" align="center">

     <tr class="listagem" >

		 <td width="49%"><span class="titulo">:: Índice geral f&aacute;brica - mensal :: 

		   <?=$Categoria?>

		 </span></td>

       	 <td width="51%"><div align="right"><span class="titulo"><a href="javascript: abrir_help('#relindicegeral');">Help</a></span>&nbsp;</div></td>
