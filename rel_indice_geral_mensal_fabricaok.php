<? $Title = "Índice Geral Mensal - Fábrica";
...
<table width="100%" border="0" cellpadding="0" cellspacing="1">
  ...
  <tr>
    ...
    <td width="20%" class="imp_normal_total"><div align="center"><strong><?=$UnidadeMedida?></strong></div></td>
		  ...
		  <tr>
			  ...
			  <td colspan="4" class="imp_normal"><table width="95%"  border="0" align="right">
                ...
                <tr>
                  ...
                  <td width="37%" class="imp_normal_total"><strong>F&aacute;brica</strong></td>
