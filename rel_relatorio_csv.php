<? include("inc/headerI.inc.php"); 
	verifyAcess("REL_ARQUIVO_CSV","S");
?>
<form name="form" method="post" action="rel_relatorio_csvok.php" target="windowPrint">
<tr>
    <td height="100%" valign="top" class="tab_conteudo">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="32" class="tab_titulo"><h4>Relat&oacute;rio Geral - Gerar arquivo CSV</h4></td>
      </tr>
    </table>
    ...
    <table width="100%"  border="0" class="tab_inclusao">
        <tr  class="listagem" >
          ...
          <td width="73%" a href="cad_defeitos.php">
            <input name="LANCA_NUMRAR" type="text" class="form" id="LANCA_NUMRAR" size="13" maxlength="12" disabled>          </td>
        </tr>
        <tr  class="listagem"
>
          <td >
...
>
          <td ><div align="center">
              <input name="C_GRUPO_EMPRESARIAL" onclick="checkControl(this.checked,new Array('GRUPO_EMPRESARIAL'))" type="checkbox" class="style1" id="C_GRUPO_EMPRESARIAL" value="radiobutton" />
          </div></td>
          <td a="a" href="cad_defeitos.php">Grupo Empresarial </td>
          <td a="a" href="cad_defeitos.php"><select name="GRUPO_EMPRESARIAL" class="form" id="GRUPO_EMPRESARIAL" disabled="disabled">
              <option value="">...Selecione</option>
              <? 
				$Sql = " SELECT DISTINCT PESSOA, NOME ";
				$Sql.= " FROM pessoa ";
				$Sql.= " WHERE PESSOA IN (SELECT GRUPO_EMPRESARIAL";
				$Sql.= "                   FROM rar_usuarioxcliente, pessoa ";
				$Sql.= "                  WHERE USUCLI_PESSOA = PESSOA";
				$Sql.= "                        AND USUCLI_USUAR_IDO = " .$_SESSION['sId'].")";
				$Sql.= "       and ecliente IN ('S',1)";
				$Sql.= " ORDER BY PESSOA";
				
				
				$Sql = " SELECT DISTINCT PESSOA, NOME ";
				$Sql.= " FROM vw_rar_lancamento_geral, pessoa, rar_usuarioxcliente ";
				$Sql.= " WHERE grupoempresarial = pessoa ";
				$Sql.= "       AND cod_cliente = usucli_pessoa ";
				$Sql.= "       AND usucli_usuar_ido = " .$_SESSION['sId'];
				$Sql.= " order by PESSOA";
				$Stmt = mysql_query($Sql);
			   	while($Rs = mysql_fetch_assoc($Stmt)) {  ?>
        ...
        <tr  class="listagem">
          ...
          <td a href="cad_defeitos.php">
              <input name="LINHA" type="text" class="form" id="LINHA" size="6" maxlength="4" disabled>          </td>
        </tr>
        <tr  class="listagem">
          <td >
            <div align="center">
          ...
          <td a href="cad_defeitos.php">
              <input name="MODELO" type="text" class="form" id="MODELO" size="10" maxlength="8" disabled>          </td>
        </tr>
        <tr  class="listagem"
>
          <td >
...
>
          <td ><div align="center">
              <input name="C_CATEGORIA" type="checkbox" onclick="checkControl(this.checked,new Array('CATEGORIA'))" class="style1" id="C_CATEGORIA" />
          </div></td>
          <td a="a" href="cad_defeitos.php">Categoria</td>
          <td a="a" href="cad_defeitos.php"><select name="CATEGORIA" class="form" id="CATEGORIA" disabled="disabled">
              <option value="">...Selecione</option>
