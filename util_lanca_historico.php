...
<form name="form" method="post" action="util_lanca_historicook.php" enctype="multipart/form-data">

<table width="100%"  border="0" align="center">

     <tr>

       <td width="49%"><span class="titulo">:: Inser&ccedil;&atilde;o de reclama&ccedil;&atilde;o anterior:: </span></td>
  ...
  <tr>
   ...
   <td colspan="9"><table width="100%"  border="0" class="tabela">
     ...
     <tr>
	   ...
	   <select name="LANCA_FABRI_IDO" class="campo_texto" id="LANCA_FABRI_IDO">

         <option value="">..Selecione</option>

         <? 

		 $Sql = "SELECT DISTINCT PESSOA_FORNECEDOR FROM PEDIDO_COMPRA order by PESSOA_FORNECEDOR";

		 $Stmt = mysql_query($Sql);

				   while($Rs = mysql_fetch_assoc($Stmt)) {  ?>

         <option value="<?=$Rs["PESSOA_FORNECEDOR"]?>"> <?=arrumaPessoa($Rs["PESSOA_FORNECEDOR"])?>
...
function verificaForm(formObj) {
	...
	formObj.action = "util_lanca_historicook.php";
