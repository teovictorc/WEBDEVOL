...
/*
   Milonic DHTML Menu HTML Unordered List Based Module version 1.1 - 4th April 2005
...
_y4=_d.links[_a];
	...
	if(pE.tagName=="LI"){
		...
		if(ie)txt=_y4.innerHTML;else txt=_y4.text;
...
_d.write("<script>"+_y6+"drawMenus();<\/script>")