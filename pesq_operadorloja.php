...
$_pagi_sql = "SELECT * FROM rar_operadorloja";
if (isset($_GET["busca"])){
	$_pagi_sql.= " WHERE opelj_nome LIKE '%" . addslashes($_GET["busca"]) . "%'";
}
$_pagi_sql.= " ORDER BY opelj_nome";
...
function setSubmit(acao, vlr)
{
	...
	{
		case 'procurar'	:	form.action = 'pesq_operadorloja.php?busca=' + vlr;	form.submit();	break;
		default			:	break;
	}
}
//-->
...
<tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="32" class="tab_titulo"><h4>Cadastro de operador loja</h4></td>
      </tr>
      </table>  
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_cadastro">
      <tr>
        <td width="250"><a href="#" onClick="javascript: deleteById('del_operadorloja.php', document.form.IDS);"><img src="../img/bts/apagar.jpg" width="20" height="20" border="0" align="absmiddle" alt="Apagar selecionadas" /></a> Apagar selecionadas</td>
	...
	while($Rs = mysql_fetch_assoc($_pagi_result)) { 
      ...
      <tr bordercolor="<?=$cor?>" class="tab_usuarios_info" onMouseOver="javascript:this.bgColor='#F9F9F9'" onMouseOut="javascript:this.bgColor='#F0F0F0'">
        <td width="22"><input type="checkbox" name="IDS" id="IDS" value="<?=$Rs["OPELJ_IDO"]?>" /></td>
        <td><a href="cad_operadorloja.php?Id=<?=$Rs["OPELJ_IDO"]?>"><?=$Rs["OPELJ_NOME"]?></a></td>
        <td><?=strtolower($Rs["OPELJ_EMAIL"])?></td>
		<td>
			<div align="center"><a href="cad_operadorloja.php?Id=<?=$Rs["OPELJ_IDO"]?>"><img src="../img/bts/editar.jpg" alt="Editar" width="20" height="20" border="0" /></a>
		    <a href="#" onClick="javascript: deleteById('del_operadorloja.php', '<?=$Rs["OPELJ_IDO"]?>');"><img src="../img/bts/apagar.jpg" alt="Excluir" width="20" height="20" border="0" /></a>	          </div></td>
      </tr>
<? } ?>
	</table>
	<br/ >
