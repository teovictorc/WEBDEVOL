...
<tr>
   ...
   <table width="100%"  border="0" class="tab_inclusao">
     ...
     <tr>
       ...
       <td height="10" colspan="3" bgcolor="#FFFFFF"><table width="100%"  border="0">

         <tr valign="middle" bgcolor="#FFFFFF" class="">

           <td width="2%"><input name="LANCA_CATEGORIA" type="radio" class="" value="1" <? if ($Categoria == "1"){?> checked <? }?> onClick="MostraDados(1);clearNF();"></td>

           <td width="8%" class=""><img src="imagens/sapato.jpg" width="60" height="45" class="style1"></td>

           <td width="15%" class="">Cal&ccedil;ado</td>

           <td width="2%"><input name="LANCA_CATEGORIA" type="radio" class="" value="5" <? if ($Categoria == "5"){?> checked <? }?> onClick="MostraDados(2);clearNF();"></td>

           <td width="8%" class=""><img src="imagens/bolsa.jpg" width="60" height="45" class="style1"></td>

           <td width="15%" class="">Bolsa</td>

           <td width="2%"><input name="LANCA_CATEGORIA" type="radio" class="" value="6" <? if ($Categoria == "6"){?> checked <? }?> onClick="MostraDados(3);clearNF();"></td>

           <td width="8%" class=""><img src="imagens/cinto.jpg" width="60" height="45" class="style1"></td>

           <td width="15%" class="">Cinto</td>

           <td width="2%"><input name="LANCA_CATEGORIA" type="radio" class="" value="7" <? if ($Categoria == "7"){?> checked <? }?> onClick="MostraDados(4);clearNF();"></td>

           <td width="8%" class=""><img src="imagens/carteira.jpg" width="60" height="45" class="style1"></td>

           <td width="15%" class="">Carteira</td>
     ...
     <tr>
       ...
       <td height="10" colspan="3"><input name="LANCA_SOLICITANTE" type="text" class="form" id="LANCA_SOLICITANTE" value="<?=$_GET['LANCA_SOLICITANTE']?>" size="50" maxlength="50"></td>
	 ...
	 <tr bgcolor="#FFFFFF" class="">
	   ...
	   <input name="LANCA_TIPORECLAMACAO" type="radio" value="C" <? if ($_GET['LANCA_TIPORECLAMACAO'] == "C") {?> checked <? } ?> > Defeito consumidor

	   <input name="LANCA_TIPORECLAMACAO" type="radio" value="L" <? if ($_GET['LANCA_TIPORECLAMACAO'] == "L") {?> checked <? } ?> > Defeito loja </td>
     ...
     <tr>
       ...
       <td height="15" class=""><input name="ITEM_REFERENCIA" type="text" class="form" id="ITEM_REFERENCIA" size="19" maxlength="16" onKeyDown="clearNF()" value="<?=$_GET['ITEM_REFERENCIA']?>"></td>
	   ...
	   <div id="numeropar" style="display:">
		   ...
		   <table width="100%"  border="0">
			 ...
			 <tr class="">
			   ...
			   <td align="center"><input name="ITEM_NUM33" type="text" align="center" class="form" id="ITEM_NUM33" value="<?=$Num33?>" size="3" maxlength="3" onKeyPress="return JSUtilApenasNumero(event);" onChange="SomaQtde();"></td>

			   <td align="center"><input name="ITEM_NUM34" type="text" align="center" class="form" id="ITEM_NUM34" value="<?=$Num34?>" size="3" maxlength="3" onKeyPress="return JSUtilApenasNumero(event);" onChange="SomaQtde();"></td>

			   <td align="center"><input name="ITEM_NUM35" type="text" align="center" class="form" id="ITEM_NUM35" value="<?=$Num35?>" size="3" maxlength="3" onKeyPress="return JSUtilApenasNumero(event);" onChange="SomaQtde();"></td>

			   <td align="center"><input name="ITEM_NUM36" type="text" align="center" class="form" id="ITEM_NUM36" value="<?=$Num36?>" size="3" maxlength="3" onKeyPress="return JSUtilApenasNumero(event);" onChange="SomaQtde();"></td>

			   <td align="center"><input name="ITEM_NUM37" type="text" align="center" class="form" id="ITEM_NUM37" value="<?=$Num37?>" size="3" maxlength="3" onKeyPress="return JSUtilApenasNumero(event);" onChange="SomaQtde();"></td>

			   <td align="center"><input name="ITEM_NUM38" type="text" align="center" class="form" id="ITEM_NUM38" value="<?=$Num38?>" size="3" maxlength="3" onKeyPress="return JSUtilApenasNumero(event);" onChange="SomaQtde();"></td>

			   <td align="center"><input name="ITEM_NUM39" type="text" align="center" class="form" id="ITEM_NUM39" value="<?=$Num39?>" size="3" maxlength="3" onKeyPress="return JSUtilApenasNumero(event);" onChange="SomaQtde();"></td>

			   <td align="center"><input name="ITEM_NUM40" type="text" align="center" class="form" id="ITEM_NUM40" value="<?=$Num40?>" size="3" maxlength="3" onKeyPress="return JSUtilApenasNumero(event);" onChange="SomaQtde();"></td>
		   ...
		   <table width="100%"  border="0" cellpadding="0" cellspacing="0">
			 ...
			 <tr>
			   ...
			   <td width="70%"><span class="">
				 ...
				 <input name="ITEM_QTDE" type="text" class="campo_texto" id="ITEM_QTDE2" size="5" maxlength="50" onKeyPress="return JSUtilApenasNumero(event);" onKeyUp="calcAll()" value="<?=$_GET['ITEM_QTDE']?>">
         ...
         <tr>
           ...
           <td width="32%"><table width="99%"  border="0">
             ...
             <tr>
               ...
               <td>
                 ...
                 <div align="left">
                   ...
                   <input name="fileProd" type="file" class="campo_texto" id="fileProd" onChange="viewImage(this,'1');" size="15"> 
             ...
             <tr>
               ...
               <td><img src="img/foto.jpg" name="imgFile1" ></td>
           ...
           <td width="33%"><table width="99%"  border="0">
             ...
             <tr>
               ...
               <td>
                 ...
                 <div align="left">
                   ...
                   <input name="fileSola" type="file" class="campo_texto" id="fileSola" onChange="viewImage(this,'2');" size="15">
             ...
             <tr>
               ...
               <td><img src="img/foto.jpg" name="imgFile2"  id="imgFile2"></td>
           ...
           <td width="33%"><table width="99%"  border="0">
             ...
             <tr class="">
               ...
               <td>
                 ...
                 <div align="left">
                   ...
                   <input name="fileDefe" type="file" class="campo_texto" id="fileDefe" onChange="viewImage(this,'3');" size="15">
             ...
             <tr>
               ...
               <td><img src="img/foto.jpg" name="imgFile3" id="imgFile3"></td>
...
function ConsistNotaFiscal() {
	...
	if (document.form.LANCA_PESSOA.value == "" || document.form.ITEM_REFERENCIA.value == "")
		...
		JSUtilRequest('autoCompletar.php?cmd=p_r&NF=' + escape(document.form.ITEM_NF.value) + '&PESSOA=' + escape(document.form.LANCA_PESSOA.value) + '&REFERENCIA=' + escape(document.form.ITEM_REFERENCIA.value) + '&NOMECLIENTE=' + escape(document.form.NOME.value) + '&Categoria='+escape(categoria));
...
function verificaForm(formObj) {
	...
	if (formObj.MENU.value != "3" || (formObj.MENU.value == "3" && !document.form.LANCA_CATEGORIA[0].checked)){
		...
		if (formObj.fileProd.value == "") {

			alert("Preencha a foto do produto");

			return;

		}else if (!validaTypeImg(formObj.fileProd.value)) {
		...
		if (formObj.fileSola.value == "") {

			alert("Preencha a foto da sola");

			return;

		}else if (!validaTypeImg(formObj.fileSola.value)) {
		...
		if (formObj.fileDefe.value == "") {

			alert("Preencha a foto do defeito");

			return;

		}else if (!validaTypeImg(formObj.fileDefe.value)) {
...
<?	if (trim($_GET['LANCA_PESSOA']) && trim($_GET['LANCA_MOVITO'])) { ?>
