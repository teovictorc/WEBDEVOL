...
?>
<form name="form" method="post" action="rel_indice_devolucaoxfabricaok.php" target="windowPrint">
<table width="100%"  border="0" align="center">
     <tr class="">
		 <td width="49%" class="tab_titulo" style="padding-top:15px;"><h4>Índice de devolução x fábrica</h4></td>
	</tr>
</table>
...
<table width="100%"  border="0" align="center">
        <tr  class="">
          <td width="1%" >&nbsp;</td>
          <td width="26%">Ordena&ccedil;&atilde;o do relat&oacute;rio </td>
          <td width="73%">
...
function validaForm(formObj) {
	...
	if (!JSUtilValidaData(formObj.AVALI_AREZ_DATAI.value,formObj.C_AVALI_AREZ_DATA.checked)
		...
		alert("Preencha o campo \"Data de avaliação\" ou desabilite a opção !");
