...
<table width="100%"  border="0" align="center">
     ...
     <tr class="listagem" >
		 ...
		 <td width="49%"><span class="titulo">:: Índice de defeitos - resumo:: 

		   <?=$Categoria?>

		 </span></td>

       	 <td width="51%"><div align="right"><span class="titulo"><a href="javascript: abrir_help('#relindicedefeitosxlinhaxfabrica');">Help</a></span>&nbsp;</div></td>
    ...
    <table width="100%"  border="0" class="tabela">
        ...
        <tr  class="listagem" >
          ...
          <td width="73%" a href="cad_defeitos.php">
            ...
            <input name="LANCA_NUMRAR" type="text" class="campo_texto" id="LANCA_NUMRAR" size="13" maxlength="12" disabled>
...
>
          ...
          <td >
            ...
            <div align="center">
              ...
              <input name="C_AVALI_SITUACAO" type="checkbox" class="style1" id="C_AVALI_SITUACAO" onClick="checkControl(this.checked,new Array('AVALI_SITUACAO'))" value="radiobutton" checked>
          ...
          <td a href="cad_defeitos.php">
              ...
              <select name="AVALI_SITUACAO" class="campo_texto" id="AVALI_SITUACAO" >

                <option value="">...Selecione</option>

                <option value="P" selected>Procedente</option>
...
>
          ...
          <td a href="cad_defeitos.php">Tempo</td>
