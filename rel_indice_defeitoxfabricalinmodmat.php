...
?>
<form name="form" method="post" action="rel_indice_defeitoxfabricalinmodmatok.php" target="windowPrint">
<table width="100%"  border="0" align="center">
     <tr class="">
		 <td width="49%" class="tab_titulo" style="padding-top:15px;"><h4>Índice de defeitos x fábrica x linha x modelo x material</h4></td>
	</tr>
</table>
...
<table width="100%"  border="0" align="center">
        <tr  class="">
          <td >&nbsp;</td>
          <td a href="cad_defeitos.php">Ordena&ccedil;&atilde;o do relat&oacute;rio </td>
