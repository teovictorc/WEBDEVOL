...
function verificaForm(formObj) {
	...
	formObj.action = "util_alt_serieok.php";
...
<form name="form" method="post" action="util_alt_serieok.php">
...
<table width="100%"  border="0" align="center">
     ...
     <tr>
       ...
       <td width="51%"><div align="right"><span class="titulo"><a href="javascript: abrir_help('#altserieprenf');">Help</a></span></div></td>
  ...
  <tr>
   ...
   <td colspan="9"><table width="100%"  border="0" class="tabela">
     ...
     <tr>
      ...
      <td class="style2"><strong>Série:</strong></td>

      <td colspan="6"><input name="PRENF_SERIE" type="text" class="campo_texto" id="PRENF_SERIE" value="<?=$Rs["PRENF_SERIE"]?>" size="10" maxlength="10"></td>
