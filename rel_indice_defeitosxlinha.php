...
?>
<form name="form" method="post" action="rel_indice_defeitosxlinhaok.php" target="windowPrint">
<table width="100%"  border="0" align="center">
     <tr class="">
		 <td width="49%" class="tab_titulo" style="padding-top:15px;"><h4>Índice de defeitos x linha</h4></td>
	</tr>
</table>
