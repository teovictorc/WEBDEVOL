...
?>
<form name="form" method="post" action="rel_gerenciamento_etapaok.php" target="windowPrint">
<table width="100%"  border="0" align="center">
     <tr class="">
		 <td width="49%" class="tab_titulo" style="padding-top:15px;"><h4>Gerenciamento de etapas</h4></td>
	</tr>
</table>
...
function validaForm(formObj) {
	...
	abrir_janela_popup('','windowPrint','scrollbars=yes, resizable=yes, fullscreen=yes,menubar=no,directories=no,toolbar=no');
