...
<form name="form" method="post" action="rel_listagem_clientexultimacoletaok.php" target="windowPrint">

<table width="100%"  border="0" align="center">

     <tr class="listagem" >

		 <td width="49%"><span class="titulo">:: Listagem de cliente x última data de coleta ::</span></td>
...
>
          ...
          <td a href="cad_defeitos.php">
			...
			<? $Sql = "SELECT DISTINCT PESSOA,NOME FROM RAR_USUARIOXCLIENTE, PESSOA, RAR_LANCAMENTO ".
			   ...
			   <option value="<?=ociresult($Stmt,"PESSOA")?>"><?=arrumaPessoa(ociresult($Stmt,"NOME"))?></option>
...
>
          ...
          <td a href="cad_defeitos.php">
			...
			<? $Stmt = mysql_query("SELECT USUCLI_PESSOA, NOME FROM RAR_USUARIOXCLIENTE, PESSOA WHERE PESSOA = USUCLI_PESSOA AND USUCLI_USUAR_IDO = " .$_SESSION['sId']. " ORDER BY USUCLI_PESSOA");
			   ...
			   <option value="<?=ociresult($Stmt,"USUCLI_PESSOA")?>"><?=arrumaPessoa(ociresult($Stmt,"USUCLI_PESSOA"))?> - <?=ociresult($Stmt,"NOME")?></option>
