...
<form name="form" method="post" action="util_tira_icmsok.php">

<table width="100%"  border="0" align="center">

     <tr>

       <td width="49%"><span class="titulo">:: Correção de ICMS ::</span></td>

       <td width="51%"><div align="right"><span class="titulo"><a href="javascript: abrir_help('#tiraricms');">Help</a></span></div></td>
  ...
  <tr>
   ...
   <td colspan="9"><table width="100%"  border="0" class="tabela">
	 ...
	 <tr>
       ...
       <td width="34%" height="10" class="style2"><strong>% ICMS:</strong></td>

       <td width="66%" height="10"><input name="icms" type="text" class="campo_texto" id="icms" value="0" size="3" maxlength="3"></td>
...
function verificaForm(formObj) {
	...
	if (formObj.icms.value == "") {

		alert("O Campo '% ICMS' é Obrigatório !");
	...
	formObj.action = "util_tira_icmsok.php";
