...
<table width="100%"  border="0" align="center">
     ...
     <tr class="listagem" >
		 ...
		 <td width="86%"><span class="titulo">:: Relat&oacute;rio de etapas pendentes ::

		   <?=$Categoria?>

		 </span></td>

       	 <td width="14%"><div align="right"><span class="titulo"><a href="javascript: abrir_help('#relindicedefeitosxpar');">Help</a></span>&nbsp;</div></td>

	</tr>

	<tr class="listagem" >

	  <td colspan="2"><div align="center"><strong>Assinale os crit&eacute;rios que deseja pesquisar e depois clique em IMPRIMIR</strong></div></td>
...
>
          ...
          <td a href="cad_defeitos.php">
			...
			<? $Sql = "SELECT DISTINCT PESSOA, NOME FROM RAR_USUARIOXCLIENTE, PESSOA, RAR_LANCAMENTO ".
						...
						"WHERE LANCA_PESSOA = USUCLI_PESSOA ".

						"      AND PESSOA = LANCA_FABRI_IDO ".

						"      and lanca_fabri_ido in (select usufor_pessoa from rar_usuarioxfornecedor where USUFOR_USUAR_IDO = " .$_SESSION['sId'].")".

						"      AND USUCLI_USUAR_IDO = " .$_SESSION['sId']. " ORDER BY NOME";					

			   $Stmt = mysql_query($Sql);

			   while($Rs = mysql_fetch_assoc($Stmt)) {  ?>

			   <option value="<?=$Rs["PESSOA"]?>"><?=$Rs["NOME"] ." (".$Rs["PESSOA"].")"?></option>
...
>
          ...
          <td >
            ...
            <div align="center">
              ...
              <input name="C_CHEGADA" onClick="checkControl(this.checked,new Array('CHEGADAI','CHEGADAF'))" type="checkbox" class="style1" id="C_CHEGADA" value="radiobutton">

          </div></td>

          <td a href="cad_defeitos.php">Chegada transportadora</td>

          <td a href="cad_defeitos.php"> <span class="style1">de

                <input name="CHEGADAI" type="text" id="CHEGADAI" style="border: 1px solid #999; color: #072A66; font-size: 11px; padding: 3px; vertical-align: middle; width: auto; font-family: tahoma; line-height: 10px; font-style: normal;" size="9" maxlength="10" disabled onKeyPress="return JSUtilApenasNumero(event);" onKeyUp="JSUtilMascara(this,event,'__/__/____');" #invalid_attr_id="#FFF">

    a

    <input name="CHEGADAF" type="text" id="CHEGADAF" style="border: 1px solid #999; color: #072A66; font-size: 11px; padding: 3px; vertical-align: middle; width: auto; font-family: tahoma; line-height: 10px; font-style: normal;" size="9" maxlength="10"  disabled onKeyPress="return JSUtilApenasNumero(event);" onKeyUp="JSUtilMascara(this,event,'__/__/____');" #invalid_attr_id="#FFF">
...
>
          ...
          <td >
            ...
            <div align="center">
              ...
              <input name="C_CHEGADA2" onClick="checkControl(this.checked,new Array('CHEGADA2I','CHEGADA2F'))" type="checkbox" class="style1" id="C_CHEGADA2" value="radiobutton">
          ...
          <td a href="cad_defeitos.php"> <span class="style1">de
                ...
                <input name="CHEGADA2I" type="text" id="CHEGADA2I" style="border: 1px solid #999; color: #072A66; font-size: 11px; padding: 3px; vertical-align: middle; width: auto; font-family: tahoma; line-height: 10px; font-style: normal;" size="9" maxlength="10" disabled onKeyPress="return JSUtilApenasNumero(event);" onKeyUp="JSUtilMascara(this,event,'__/__/____');" #invalid_attr_id="#FFF">

    a

    <input name="CHEGADA2F" type="text" id="CHEGADA2F" style="border: 1px solid #999; color: #072A66; font-size: 11px; padding: 3px; vertical-align: middle; width: auto; font-family: tahoma; line-height: 10px; font-style: normal;" size="9" maxlength="10"  disabled onKeyPress="return JSUtilApenasNumero(event);" onKeyUp="JSUtilMascara(this,event,'__/__/____');" #invalid_attr_id="#FFF">
...
>
          ...
          <td a href="cad_defeitos.php"><select name="etapa" class="style1" id="etapa">
