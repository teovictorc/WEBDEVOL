<? $Title = "Índice de Defeitos x Fábrica";
	...
	$SQL = "select F.NOME F_NOME, sum(I.item_qtde) as QTDE ";
	...
	while($Rs = mysql_fetch_assoc($Stmt)){ 
		...
		$Total+= intval($Rs["QTDE"]); ?>
		  ...
		  <tr>
			...
			<div align="left" class="imp_normal_total_fundoamarelo"><strong>F&aacute;brica:&nbsp;</strong><?=$Rs["F_CODIGO"]?> - <?=$Rs["F_NOME"]?></div>      

			<div align="right"></div></td>

			<td width="16%" bgcolor="#f5f5f5" class="imp_normal_total_fundoamarelo"><strong>Quantidade:&nbsp;</strong><?=number_format($Rs["QTDE"], 0, ',', '.')?></td>
...
&nbsp;% sobre total </div></td>
		...
		<? while($Rs2 = mysql_fetch_assoc($Stmt2)){ ?>
			...
			<tr>
				...
				<td width="10%" bgcolor="#f5f5f5" class="imp_normal_total">Quantidade:&nbsp;<?=number_format($Rs2["QTDE"], 0, ',', '.')?></td>

			    <td bgcolor="#f5f5f5" class="imp_normal_total"><div align="right">

                    <?=round(($Rs2["QTDE"]/$Rs["QTDE"]) * 100,2)?>

&nbsp;% sobre f&aacute;brica </div></td>
			...
			<tr>
			  ...
			  <td width="7%" class="imp_normal">&nbsp;</td>

			  <td class="imp_normal">Sub-grupo de defeito:&nbsp;<?=$Rs3["D_NOME"]?></td>
