<? $Title = "Índice de Defeitos x Estado";
	...
	$SQL.= " where L.LANCA_PESSOA = F.PESSOA ";
	...
	$SQL = "select SG_UF, sum(I.item_qtde) as QTDE ";
	...
	while($Rs = mysql_fetch_assoc($Stmt)){ 
		...
		$Total+= intval($Rs["QTDE"]); ?>
		  ...
		  <tr>
			...
			<div align="left" class="imp_normal_total_fundoamarelo"><strong>UF:&nbsp;</strong><?=$Rs["SG_UF"]?></div>      

			<div align="right"></div></td>

			<td width="17%" bgcolor="#f5f5f5" class="imp_normal_total_fundoamarelo"><strong>Quantidade:&nbsp;</strong><?=number_format($Rs["QTDE"], 0, ',', '.')?></td>
...
&nbsp;% sobre cole&ccedil;&atilde;o </div></td>
			...
			<tr>
			  ...
			  <td width="57%" class="imp_normal">Sub-grupo de defeito:&nbsp;<?=$Rs3["D_NOME"]?></td>
